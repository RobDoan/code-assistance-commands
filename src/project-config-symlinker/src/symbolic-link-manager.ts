import { symlink, rm, access, stat, readdir, mkdir, lstat } from 'fs/promises';
import { resolve, join, dirname, relative } from 'path';
import type { ConfigurationEntry, LinkOperationResult } from './types.js';
import PathValidator from './path-validator.js';
import UserPrompt, { type ConfirmationOptions, type ConfirmationResult } from './user-prompt.js';
import DirectoryCreator from './directory-creator.js';
import { Logger, ConfigSymlinkerError, ErrorCode, ErrorRecovery } from './error-handler.js';
